...
args_list <- list(
  # args <- c("1",'100', "150","200","3","3","1","1","1","3","0.1","0.8",'Gauss','Gauss01', '0'),
  # args <- c("1",'100', "150","200","3","3","1","1","1","2","0.1","0.8",'Gauss','Gauss01', '0'),
  # args <- c("1",'100', "150","200","3","3","1","1","0.5","2","0.1","0.8",'Gauss','Gauss01', '0'),
  # args <- c("1",'100', "150","200","3","3","1","1","0.5","3","0.1","0.8",'Gauss','Gauss01', '0'),
  # args <- c("1",'100', "150","200","3","3","1","1","0.25","3","0.1","0.8",'Gauss','Gauss01', '0'),
  # args <- c("1",'100', "150","200","3","3","1","1","0.1","3","0.1","0.8",'Gauss','Gauss01', '0'),
  args <- c("1",'100', "150","200","3","3","1","1","1","3","0.1","0.8",'Gauss','Gauss01', '0'),
  # args <- c("1",'100', "150","200","3","3","1","1","1","3","0.1","0.8",'Gauss','Gauss01', '2'),
  # args <- c("1",'100', "150","200","3","3","1","1","1","3","0.1","0.8",'Gauss','Gauss01', '3')
  args <- c("1",'100', "150","200","3","3","1","1","1","3","0.1","0.8",'Gauss','Gauss01', '1')
  # args <- c("1",'100', "150","200","3","3","1","1","1","2","0.1","0.8",'Gauss','Gauss01', '1'),
  # args <- c("1",'100', "150","200","3","3","1","1","0.5","2","0.1","0.8",'Gauss','Gauss01', '1'),
  # args <- c("1",'100', "150","200","3","3","1","1","0.5","3","0.1","0.8",'Gauss','Gauss01', '1'),
  # args <- c("1",'100', "150","200","3","3","1","1","0.25","3","0.1","0.8",'Gauss','Gauss01', '1'),
  # args <- c("1",'100', "150","200","3","3","1","1","0.1","3","0.1","0.8",'Gauss','Gauss01', '1'),
  # args <- c("1",'100', "150","200","3","3","1","1","1","3","0.1","0.5",'Gauss','Gauss01', '0'),
  # args <- c("1",'100', "150","200","3","3","1","1","2","3","0.1","0.5",'Gauss','Gauss01', '0'),
  # args <- c("1",'100', "150","200","3","3","1","1","2","3","0.1","0.2",'Gauss','Gauss01', '0'),
  # args <- c("1",'100', "150","200","3","3","1","1","2","4","0.1","0.2",'Gauss','Gauss01', '0')
  # args <- c("1",'100', "150","200","3","3","1","1","1","3","0.1","0.5",'Gauss','Gauss01', '1'),
  # args <- c("1",'100', "150","200","3","3","1","1","2","3","0.1","0.5",'Gauss','Gauss01', '1'),
  # args <- c("1",'100', "150","200","3","3","1","1","2","3","0.1","0.2",'Gauss','Gauss01', '1'),
  # args <- c("1",'100', "150","200","3","3","1","1","2","4","0.1","0.2",'Gauss','Gauss01', '1')
  # args <- c("1",'100', "150","200","3","3","1","1","3","3","0.1","0.2",'Gauss','Gauss01', '1'),
  # args <- c("1",'100', "150","200","3","3","1","1","3","3","0.1","0.2",'Gauss','Gauss01', '0'),
  # args <- c("1",'100', "150","200","3","3","1","1","3","4","0.1","0.2",'Gauss','Gauss01', '1')
  # args <- c("1",'100', "150","200","3","3","1","1","3","4","0.1","0.2",'Gauss','Gauss01', '0')
)
modelFamily <- as.character(args_list[[1]][13])
ICL         <- as.integer(args_list[[1]][15])
mu          <- c(as.numeric(args_list[[1]][9]),as.numeric(args_list[[1]][10]))
...
label_from_args <- function(args) {
  # sprintf("ICL=%s, prob=%s_%s, mu=%s_%s",
  #         args[15], args[11], args[12], args[9], args[10])
  sprintf("prob=%s_%s, mu=%s_%s",
          args[11], args[12], args[9], args[10])
}
...
plt_multi <- fdr_all %>%
  ...
  #                         "mu=1_3, prob=0.1_0.8, ICL=0" = "B1 = B2 = 3",
  #                         "mu=1_3, prob=0.1_0.8, ICL=1" = "ICL",
  #                         "mu=1_3, prob=0.1_0.8, ICL=2" = 'B1 = B2 = 1',
  #                         "mu=1_3, prob=0.1_0.8, ICL=3" = "B1 = B2 = 5")) %>%
...
facet_wrap(~ Setting, scales = "free", nrow = 3) +
...
outfile <- file.path(output_folder_figure, 
                     paste0(modelFamily, '_ICL', ICL, '_mu', paste0(mu, collapse = '_'), 
                            '_',paste0(prob, collapse = '_'),"_fdrtdr_multi_settings.png"))
save_plot(plt_multi, file = outfile, base_height = 7)
...
if (nrow(prop_all) == 0) {
  ...
  save_plot(
    plt_prop_multi,
    file = outfile_prop,
    base_height = 10,  # tweak if you have many Settings or alpha levels
    base_width  = 10
  )
}
